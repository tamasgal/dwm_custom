...
static const char *mailcmd[]       = { "kitty", "mutt", "-e", "neomutt", NULL };
...
static const char *voldowncmd[]    = { "amixer", "set", "Master", "6%-", NULL };
static const char *volupcmd[]      = { "amixer", "set", "Master", "6%+", NULL };
