...
static const char *musnext[]       = { "st", "-t", "cmus-remote", "--next", NULL };
static const char *muspause[]      = { "st", "-t", "cmus-remote", "--pause", NULL };
static const char *musprev[]       = { "st", "-t", "cmus-remote", "--prev", NULL };
